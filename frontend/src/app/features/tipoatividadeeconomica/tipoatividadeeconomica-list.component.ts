...
@Component({
  selector: 'app-tipoatividadeeconomica-list',
  standalone: true,
  imports: [CommonModule, FormsModule, PaginationComponent],
  template: `
    <div class="list-page">
      <div class="list-header">
        <h2>Tipo de Atividade Econômica</h2>
      ...
      <div class="table-scroll-wrapper">
        <div class="table-container">
          <table *ngIf="paged?.items?.length; else empty">
            <thead><tr><th>Codigo Tipo Atividade Economica</th><th>Descrição</th></tr></thead>
            <tbody>
...
export class TipoAtividadeEconomicaListComponent implements OnInit {
  paged: PagedResult<TipoAtividadeEconomica> | null = null;
  loading = false;
  page = 1;
  pageSize = 20;
  filterText = '';
  ...
  constructor(private service: TipoAtividadeEconomicaService, private router: Router) {}
  ...
  goNovo(): void { this.router.navigate(['/tipoatividadeeconomica', 'novo']); }
  goEdit(item: TipoAtividadeEconomica): void {
    this.router.navigate(['/tipoatividadeeconomica', item.codigoTipoAtividadeEconomica]);
  }
}
